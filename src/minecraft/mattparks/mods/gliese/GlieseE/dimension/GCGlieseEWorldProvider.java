...
import mattparks.mods.gliese.GlieseE.wgen.GCGlieseEChunkProvider;
import mattparks.mods.gliese.GlieseE.wgen.GCGlieseEWorldChunkManager;
...
public class GCGlieseEWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new GCGlieseEChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + GCGlieseEConfigManager.dimensionIDGlieseE;
    }
    ...
    {
        this.worldChunkMgr = new GCGlieseEWorldChunkManager();
    }
