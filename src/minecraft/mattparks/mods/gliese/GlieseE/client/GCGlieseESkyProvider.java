...
import mattparks.mods.gliese.GlieseE.GCGlieseE;
...
public class GCGlieseESkyProvider extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(GCGlieseE.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public GCGlieseESkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        GCGlieseEWorldProvider gcProvider = null;

        if (world.provider instanceof GCGlieseEWorldProvider)
        {
            gcProvider = (GCGlieseEWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCGlieseESkyProvider.sunTexture);
