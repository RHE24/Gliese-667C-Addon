...
import mattparks.mods.gliese.GlieseE.CommonProxyGlieseE;
...
public class ClientProxyGlieseE extends CommonProxyGlieseE
{
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
            return "Starcraft GlieseE Client";
        }
            ...
            if (type.equals(EnumSet.of(TickType.CLIENT)))
            {
                if (world != null)
                {
                    if (world.provider instanceof GCGlieseEWorldProvider)
                    {
                        ...
                        {
                            world.provider.setSkyRenderer(new GCGlieseESkyProvider());
                        }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), GCGlieseE.CHANNEL, Side.CLIENT);
    }
