...
public class GCGlieseEBiomeDecorator
{
    ...
    public GCGlieseEBiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
        this.dirtGen = new GCCoreWorldGenMinableMeta(GCGlieseEBlocks.GlieseEDirt.blockID, 32, 3, true, GCGlieseEBlocks.GlieseEGrass.blockID, 4); 
    }
