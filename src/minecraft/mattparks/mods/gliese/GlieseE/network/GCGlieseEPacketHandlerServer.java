package mattparks.mods.gliese.GlieseE.network;
...
public class GCGlieseEPacketHandlerServer implements IPacketHandler
{
    @Override
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
    {
        ...
        {
            FMLLog.severe("Starcraft GlieseE: Received bad packet!");
        }
