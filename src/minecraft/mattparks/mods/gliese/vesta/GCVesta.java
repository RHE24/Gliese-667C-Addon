...
import mattparks.mods.gliese.vesta.dimension.GCVestaTeleportType;
import mattparks.mods.gliese.vesta.dimension.GCVestaWorldProvider;
import mattparks.mods.gliese.vesta.network.GCVestaPacketHandlerServer;
...
public class GCVesta
{
    ...
    @SidedProxy(clientSide = "mattparks.mods.gliese.vesta.client.ClientProxyVesta", serverSide = "mattparks.mods.gliese.vesta.CommonProxyVesta")
    ...
    public void load(FMLInitializationEvent event)
    {
        ...
        GCLog.info("Starcraft Vesta Loaded: " + languages + " Languages.");
    ...
    {
        new GCVestaConfigManager(new File(event.getModConfigurationDirectory(), "starcraft/vesta.conf"));
